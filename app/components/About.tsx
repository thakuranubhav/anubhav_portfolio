...
function About() {
  return (
    ...
    transition={{duration:1,delay:0.8}} id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
        <motion.h4
    ...
    transition={{duration:0.6,delay:0.8}} className='flex-1'>
                <p className='mb-10 max-w-3xl font-Ovo'>
                    ...
                    Throughout my carrer,I have had the privilege of colaborating with prestigious organizations,
    ...
    transition={{duration:0.8,delay:1}}className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                    {infoList.map(({icon, iconDark,title,description},index)=>(
                        <motion.li
                        whileHover={{scale:1.05}} className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-blue-300 hover:-translate-y-1 duration-500 hover:shadow-[0_4px_4px_rgba(0,0,0,0.6)]' key={index}>
                ...
                initial={{opacity:0,y: 20}}
    whileInView={{opacity:1,y:0}}
    transition={{duration:0.5,delay:1.3}}className='my-6 text-gray-700 font-Ovo'>Tools I use</motion.h4>
